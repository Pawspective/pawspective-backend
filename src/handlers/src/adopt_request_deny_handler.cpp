...
AdoptRequestDenyHandler::AdoptRequestDenyHandler(
...
userver::formats::json::Value AdoptRequestDenyHandler::HandleRequestJsonThrow(
    ...
    try {
        adopt_request_service_.get_service().Deny(user_id, request_id);
        ...
        utils::ErrorResponse(utils::error_code::kForbidden, "You do not have permission to deny this request")
            .ThrowForbidden();
    }
}
