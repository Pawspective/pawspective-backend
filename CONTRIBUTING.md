# Contributing to PawSpective Backend

---

Thank you for your interest in contributing to PawSpective Backend. We don't
...
- Fifth rule: commit standard: `<type>(<scope>): <description>`, example:
